...
public class TestRemoveDuplicates {
	...
	public final void testEmpty() {
		k = new int[] {};
		assertTrue("False for empty set", RemoveDuplicates.uniqueElements(k).length == 0);
	...
	public final void testSame() {
		...
		assertTrue("False if length is not one", RemoveDuplicates.uniqueElements(k).length == 1);
	...
	public final void testDifferent() {
		...
		assertTrue("False if length is not 8", RemoveDuplicates.uniqueElements(k).length == 8);
	...
	public final void testUnique() {
		...
		ktest = RemoveDuplicates.uniqueElements(b);
